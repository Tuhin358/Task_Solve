...
<body>
    ...
    <div class="card col-sm-6 mb-3" style="max-width: 540px;">
        <div class="row g-0">
          ...
          <div class="col-md-4">
            <img src="{{asset('/storage/admin/'.$admin->image)}}" class="img-fluid rounded-start" style="height:100px;width:100px;" alt="">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title">{{$admin->title}}</h5>
              <p class="card-text"><h3>{{ $admin->short_desctiption }}<br></h3></p>
              <p class="card-text"><small class="text-muted">{{ $admin->date }}</small></p>
            </div>
          </div>
          @endforeach
        </div>
      ...
      <div class="card col-sm-5 mb-3" style="max-width: 540px;">
        <div class="row g-0">
          ...
          <div class="col-md-4">
            <img src="{{asset('/storage/user/'.$data->image) }}" class="img-fluid rounded-start" style="height:100px;width:100px;" alt="">
          </div>
          <div class="col-md-8">
            <div class="card-body">
                <h5 class="card-title">{{$data->title}}</h5>
                <p class="card-text"><h3>{{$data->short_desctiption }}<br></h3></p>
